...
public class RootDecoder {
    ...
    class object {
        ...
        private val ROOT_TAG_INFO = linkedMapOf(
            ...
            "dol" to TagInfo.treeStructured("DOL", "Data Object List", DataObjectListDecoder(), shortBackground = "Data Object List -  a list of (tag name, expected length) pairs"),
            ...
            "apdu-sequence" to TagInfo.treeStructured("APDUs", "Sequence of Command/Reply APDUs", APDUSequenceDecoder(ReplyAPDUDecoder(TLVDecoder()),
                    ...
                    shortBackground = "A hex string encoded trace of APDU Command Response pairs.",
