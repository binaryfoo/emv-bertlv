...
public class AmexTerminalCapabilitiesDecoderTest {
    ...
    public void testDecodeXp1_0() throws Exception {
        ...
        assertThat(dataList, hasItem(new DecodedData("Byte 1 Bit 8 = 0, Byte 1 Bit 7 = 0", "Expresspay 1.0", startIndex, startIndex + 1)));
    }
    ...
    public void testDecodeXp2_0_Magstripe() throws Exception {
        ...
        assertThat(dataList, hasItem(new DecodedData("Byte 1 Bit 8 = 0, Byte 1 Bit 7 = 1", "Expresspay 2.0 MSD", startIndex, startIndex + 1)));
    }
    ...
    public void testDecodeXp2_0_EMV() throws Exception {
        ...
        assertThat(dataList, hasItem(new DecodedData("Byte 1 Bit 8 = 1, Byte 1 Bit 7 = 0", "Expresspay 2.0 EMV & MSD", startIndex, startIndex + 1)));
    }
    ...
    public void testDecodeXpMobile_EMV() throws Exception {
        ...
        assertThat(dataList, hasItem(new DecodedData("Byte 1 Bit 8 = 1, Byte 1 Bit 7 = 1", "Expresspay Mobile - EMV", startIndex, startIndex + 1)));
    }
    ...
    public void testCVMRequired() throws Exception {
        ...
        assertThat(dataList, hasItem(new DecodedData("Byte 1 Bit 4 = 1", "CVM Required", startIndex, startIndex + 1)));
    }
    ...
    public void testCVMNotRequired() throws Exception {
        int startIndex = 4;
        List<DecodedData> dataList = decoder.decode("0000", startIndex, null);
        assertThat(dataList, hasItem(new DecodedData("Byte 1 Bit 4 = 0", "CVM Not Required", startIndex, startIndex + 1)));
    }
}