...
public class AmexTerminalCapabilitiesDecoderTest {
  ...
  @Test
  public void testDecodeXp2_0_Magstripe() {
    int startIndex = 4;
  ...
  @Test
  public void testDecodeXp2_0_EMV() {
    int startIndex = 4;
  ...
  @Test
  public void testDecodeXpMobile_EMV() {
    int startIndex = 4;
  ...
  @Test
  public void testCVMNotRequired() {
    int startIndex = 4;
    List<DecodedData> dataList = decoder.decode("0000", startIndex, new DecodeSession());
