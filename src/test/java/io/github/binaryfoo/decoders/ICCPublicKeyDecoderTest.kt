...
public class ICCPublicKeyDecoderTest {
    ...
    public fun certificateWithRemainder() {
        ...
        assertThat(decodeICCPublicKeyCertificate(recovered, byteLengthOfIssuerModulus).detail, io.github.binaryfoo.DecodedAsStringMatcher.decodedAsString("""Header: 6A
Format: 04
