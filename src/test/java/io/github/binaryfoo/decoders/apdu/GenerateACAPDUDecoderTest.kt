...
public class GenerateACAPDUDecoderTest {
    ...
    public fun testDecode() {
        ...
        assertThat(decoded.children.first, `is`(DecodedData.fromTlv(EmvTags.AMOUNT_AUTHORIZED, "9F02 (amount authorized)", "000000010001", startIndex + 5, startIndex + 11)))
    ...
    public fun testDecodeSecondGenerateAC() {
        ...
        assertThat(secondDecoded.children, hasItem(DecodedData.fromTlv(EmvTags.ISSUER_AUTHENTICATION_DATA, "91 (issuer authentication data)", "11223344556677880000", 5, 15)))
        assertThat(secondDecoded.children, hasItem(DecodedData.fromTlv(EmvTags.ICC_DYNAMIC_NUMBER, "9F4C (ICC dynamic number)", "0000000000000000", 26, 34)))
    }
}
