...
public class NumericBitStringFieldTest {
    ...
    public void edgeCases() throws Exception {
        ...
        assertThat(field.getValueIn(EmvBit.fromHex("0010")), is("Y = 0"));
        assertThat(field.getValueIn(EmvBit.fromHex("0020")), is("Y = 1"));
        assertThat(field.getValueIn(EmvBit.fromHex("0100")), is("Y = 0"));
    }
