...
public class IssuerPublicKeyDecoderTest {
    ...
    public void certificateWithPaddedPublicKey() throws Exception {
        ...
        String expected = "Header: 6A\n" +
                ...
                "Trailer: BC\n";
        RecoveredPublicKeyCertificate actual = new IssuerPublicKeyDecoder().decode(recovered, byteLengthOfCAModulus);
    ...
    public void certificateWithRemainder() throws Exception {
        ...
        RecoveredPublicKeyCertificate actual = new IssuerPublicKeyDecoder().decode(recovered, 144);
