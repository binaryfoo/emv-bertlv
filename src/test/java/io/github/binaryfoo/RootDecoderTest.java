...
import static io.github.binaryfoo.TestResources.loadExpected;
...
public class RootDecoderTest {
  ...
  public void handleOddTag() {
    String expected = loadExpected(RootDecoderTest.class, "expected-odd-tag.txt");
    ...
    List<DecodedData> decoded = rootDecoder.decode(tlv, "EMV", RootDecoder.getTagInfo("constructed"), CompliantTagMode.INSTANCE);
    assertEquals(expected, DecodedData.asSimpleString(decoded, ""));
  }
